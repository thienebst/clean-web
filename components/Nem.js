...
const steps = [
  ...
  },
  {
    ...
    description:
      "Pha loãng dung dịch tẩy rửa chuyên dụng cho ghế sofa nhung với nước theo tỉ lệ 1:10. Bạn có thể mua dung dịch này tại các cửa hàng bán đồ nội thất hoặc trên mạng ",
  },
  {
    label: "Kiểm tra chất liệu sofa có phù hợp với giặt bằng hơi nước nóng",
    description: `Nhúng khăn mềm vào dung dịch tẩy rửa và vắt khô. Sau đó lau nhẹ nhàng theo chiều của sợi nhung trên ghế sofa. Không nên lau quá mạnh hoặc quá ướt để tránh làm hỏng lớp nhung.`,
  },
  {
    label: "Dùng máy hơi nước nóng",
    description:
      "Lau lại ghế sofa bằng khăn khô hoặc giấy ăn để loại bỏ các vết ẩm và chất tẩy rửa còn sót lại. Để ghế sofa khô hoàn toàn trước khi sử dụng.",
  },
];
const Nem = () => {
  return (
    <div className="mt-12">
      ...
      <div style={{ padding: 15 }}>
        ...
        <ImageDes
          src="/assets/des5.png"
          title={"Dịch vụ giặt ghế Nem TP HCM"}
        />
      </div>
      <div style={{ padding: 15 }}>
        <div
