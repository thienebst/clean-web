      ...
      <div className="bg-white-300   px-4">
        <div className="row-span-2 sm:col-span-4 col-start-1 col-end-4 sm:col-end-5 flex flex-col items-start ">
          ...
          <p className="mb-4" style={{textAlign: 'justify'}}>
            ...
            đội ngũ nhân viên được đào tạo bài bản, nhiệt tình và trách nhiệm.
            Chúng tôi sử dụng các thiết bị hiện đại và các hóa chất an toàn cho
            sức khỏe và môi trường. Công ty TNHH Dịch Vụ Vệ Sinh Trường Vũ - Đối
